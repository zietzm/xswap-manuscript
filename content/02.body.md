...
Additionally, we believe that the performance of degree-based edge probabilities for a network edge prediction task provides information about the network itself.
